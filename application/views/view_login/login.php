  ...
  <body class="d-flex flex-column h-100">
    ...
    <nav class="navbar navbar-dark bg-dark sticky-top">
	  <div class="container-fluid">
	    ...
	    <a href="<?= base_url('blog/login') ?>" class="btn btn-dark me-1 btn-lg"><i class="fa fa-sign-in"> Login </i></a>
	  </div>
	</nav>
	...
	<div class="container my-2">
		...
		<div class="card">
		  ...
		  <div class="card-body">
		    <form method="POST" action=" <?= base_url('blog/cek_login')  ?>">
				...
				<div class="form-floating">
				  ...
				  <p>Pengguna Baru?<a href="<?= base_url('blog/register_form');  ?>" class="link-secondary">Daftar disini</a></p>
				</div>
		    </form>
		  </div>
		</div>
